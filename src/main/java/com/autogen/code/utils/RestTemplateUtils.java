...
public class RestTemplateUtils {
    ...
    public static <T> ResponseEntity<T> get(String url, Class<T> responseType) {
        return rtu.restTemplate.getForEntity(url, responseType);
    }
    ...
    public static <T> ResponseEntity<T> get(String url, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.getForEntity(url, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> get(String url, Class<T> responseType, Map<String, ?> uriVariables) {
        return rtu.restTemplate.getForEntity(constructUrl(url, uriVariables), responseType, uriVariables);
    }
     ...
     * @return ResponseEntity 响应对象封装类
     */
    public static <T> ResponseEntity<T> get(String url, Object requestBody, Class<T> responseType, Map<String, ?> uriVariables) {
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(requestBody);
        return rtu.restTemplate.exchange(constructUrl(url, uriVariables), HttpMethod.GET, requestEntity, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> get(String url, HttpHeaders headers, Class<T> responseType, Map<String, ?> uriVariables) {
        HttpEntity<?> requestEntity = new HttpEntity<>(headers);
        return exchange(constructUrl(url, uriVariables), HttpMethod.GET, requestEntity, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, Class<T> responseType) {
        return rtu.restTemplate.postForEntity(url, HttpEntity.EMPTY, responseType);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType) {
        return rtu.restTemplate.postForEntity(url, requestBody, responseType);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.postForEntity(url, requestBody, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType, Map<String, ?> uriVariables) {
        return rtu.restTemplate.postForEntity(constructUrl(url, uriVariables), requestBody, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, HttpEntity<?> requestEntity, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.exchange(url, HttpMethod.POST, requestEntity, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> put(String url, HttpEntity<?> requestEntity, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.exchange(url, HttpMethod.PUT, requestEntity, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> delete(String url, HttpEntity<?> requestEntity, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.exchange(url, HttpMethod.DELETE, requestEntity, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> exchange(String url, HttpMethod method, HttpEntity<?> requestEntity, Class<T> responseType, Object... uriVariables) {
        return rtu.restTemplate.exchange(url, method, requestEntity, responseType, uriVariables);
    }
