...
public class MainController {
    ...
    //http://127.0.0.1:8080/main/requestParameter?type=maven-project&language=java&bootVersion=2.5.6&groupId=GroupId&artifactId=ArtifactId&name=Name&description=Description&packageName=PackageName&packageing=jar&javaVersion=11&dependencies=web,postgresql,mybatis,jdbc&url=jdbc:postgresql://10.254.130.27:5433/postgres?currentSchema=public&driver=org.postgresql.Driver&username=Gencode_Dev&password=postgres&templates=1,2,3
